...
z <- descenso(2000,c(0,0),0.001,grad_ent)
tail(z,20)
```
...
## termina esta línea
z <- descenso( 2000, c(rep(0,6)),0.001, grad_ent)
tail(z,20)
```
...
probaH <-h(sum(z[2000,]*c(1,(3-1)/3,(60/60),0,1,0)))
probaH  #=0.04070177
# probabilidad sobrevivir si mujer, 1a clase, 60 años, southampton
probaM<-h(sum(z[2000,]*c(1,(1-1)/3,(60/60),1,1,0)))
probaM #=0.7988836
```
